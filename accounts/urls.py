...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, articles_journals_of_user
)
...
urlpatterns = [
    ...
    path('<username>/profile/', view=articles_journals_of_user, name="user-profile"),
